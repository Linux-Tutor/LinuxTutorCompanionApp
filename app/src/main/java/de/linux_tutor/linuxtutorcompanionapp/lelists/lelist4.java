...
public class lelist4 extends AppCompatActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private FragmentPagerAdapter_le4 myViewPagerAdapter;
    int i = 0;
    ...
    private void initializeViewPager() {
        List<Fragment> fragments_le4 = new Vector<Fragment>();
        ...
        this.myViewPagerAdapter = new FragmentPagerAdapter_le4(
